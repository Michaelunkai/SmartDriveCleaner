...
def force_delete_on_reboot(file_path):
    ...
    try:
        ...
        ctypes.windll.kernel32.MoveFileExW(
            ...
            None,
            ctypes.c_ulong(MOVEFILE_DELAY_UNTIL_REBOOT)
        )
        return True
    except Exception:
        return False
...
class RegistryCleanerThread(QThread):
    ...
    def check_registry_key(self, check_info):
        ...
        try:
            if check_info['check_type'] == 'missing_shared_dlls':
                issues.extend(self.check_missing_shared_dlls(check_info))
            elif check_info['check_type'] == 'unused_file_extensions':
                issues.extend(self.check_unused_file_extensions(check_info))
            elif check_info['check_type'] == 'activex_class_issues':
                issues.extend(self.check_activex_class_issues(check_info))
    ...
    def check_missing_shared_dlls(self, check_info):
    ...
    def check_unused_file_extensions(self, check_info):
    ...
    def check_activex_class_issues(self, check_info):
...
class MainAppWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.create_file_cleaner_page()
        
        # Create registry cleanup page
        self.create_registry_cleanup_page()
        
        # Create software update page
        self.create_software_update_page()
    ...
    def create_file_cleaner_page(self):
        ...
        # Scan type selection
        self.create_scan_type_selection()
        main_layout.addWidget(self.scan_type_frame)
        
        # Scan mode selection
        self.create_scan_mode_selection()
        ...
        # Disk space display
        self.create_disk_space_display()
    ...
    def create_registry_cleanup_page(self):
    ...
    def create_software_update_page(self):
        ...
        self.software_update_selected_button = QPushButton("⬇️ Update Selected")
        self.software_update_selected_button.setMinimumHeight(40)
        self.software_update_selected_button.setStyleSheet("""
            QPushButton {
                background-color: #1976d2;
                color: white;
                border: none;
        ...
        """)
        self.software_update_selected_button.clicked.connect(self.update_selected_software)
        controls_layout.addWidget(self.software_update_selected_button)
        
        self.software_update_all_button = QPushButton("🚀 Update All")
        self.software_update_all_button.setMinimumHeight(40)
        self.software_update_all_button.setStyleSheet("""
            QPushButton {
                background: qlineargradient(x1:0, y1:0, x2:0, y2:1,
        ...
        """)
        self.software_update_all_button.clicked.connect(self.update_all_software)
        controls_layout.addWidget(self.software_update_all_button)
    ...
    def create_software_results_table(self):
        ...
        self.software_results_table.setHorizontalHeaderLabels(["Software", "Current Version", "Available Version", "Priority", "Size", "Action"])
    ...
    def create_registry_results_table(self):
        ...
        self.registry_results_table.setHorizontalHeaderLabels(["Type", "Description", "Severity", "Size", "Action"])
    ...
    def start_registry_scan(self):
        ...
        self.registry_thread.scan_completed.connect(self.on_registry_scan_completed)
        self.registry_thread.error_occurred.connect(self.on_registry_scan_error)
        self.registry_thread.finished.connect(self.on_registry_scan_finished)
    ...
    def on_registry_scan_completed(self, registry_data):
        """Handle completion of registry scan."""
        self.registry_data = registry_data
        self.populate_registry_results_table()
    ...
    def refresh_registry_buttons(self):
    ...
    def start_software_scan(self):
        ...
        self.software_update_thread.scan_completed.connect(self.on_software_scan_completed)
        self.software_update_thread.error_occurred.connect(self.on_software_scan_error)
        self.software_update_thread.finished.connect(self.on_software_scan_finished)
    ...
    def on_software_scan_completed(self, software_data):
        """Handle completion of software update scan."""
        self.software_data = software_data
        self.populate_software_results_table()
    ...
    def refresh_software_buttons(self):
    ...
    def create_results_table(self):
        ...
        self.results_table.setHorizontalHeaderLabels(["File Path", "Size (MB)", "Action"])
    ...
    def create_scan_type_selection(self):
    ...
    def create_scan_mode_selection(self):
    ...
    def create_disk_space_display(self):
...
class HeadlessCleanupManager:
    ...
    def update_software_headless(self):
